...
public class StdUtils {
     ...
     * @return
     */
    public List<String> fileReadList(String filePath) {
        BufferedReader br = null;
     ...
     * @return
     */
    public Set<String> fileReadSet(String filePath) {
        BufferedReader br = null;
     ...
     * @param path
     */
    public static synchronized void fileWrite(String data, String path) {
     ...
     * @throws Exception
     */
    public List getSeedFileList(String path) throws Exception {
